class PyImageCropper:
    ...
    def __init__(self):
        ...
        self.button_exit.place(x=450, y=0)
        ...
        self.entry_top_string.set(self.image_handler.get_crop_box()[0])
        self.entry_top_label = self.tk.Label(text="Top:")
        self.entry_top_label.place(x=10, y=50)
        ...
        self.entry_left_string.set(self.image_handler.get_crop_box()[1])
        self.entry_left_label = self.tk.Label(text="Left:")
        self.entry_left_label.place(x=10, y=75)
        ...
        self.entry_bottom_string.set(self.image_handler.get_crop_box()[2])
        self.entry_bottom_label = self.tk.Label(text="Bottom:")
        self.entry_bottom_label.place(x=10, y=100)
        ...
        self.entry_right_string.set(self.image_handler.get_crop_box()[3])
        self.entry_right_label = self.tk.Label(text="Right:")
        self.entry_right_label.place(x=10, y=125)
